...
Original file is located at
    https://colab.research.google.com/drive/1TXLCd_beQOEnAUkroxVUC91cXv3PVAXa
"""

# ======================
# 0. Kaggle API로 데이터 자동 다운로드 (Drive X)
# ======================

import os
from pathlib import Path

# Colab에 kaggle.json 업로드해야 함
# ⚠️ 아래 셀 실행하면 파일 업로드 창 뜸
from google.colab import files
files.upload()  # kaggle.json 업로드하세요
...
print("✅ 데이터 다운로드 완료:", base_dir.exists())
...
print("✅ CSV 경로:", driver_csv_path)
print("✅ Train 경로:", train_dir)
print("✅ Test 경로:", test_dir)

print("CSV 존재 여부:", driver_csv_path.exists())
print("Train 폴더 존재 여부:", train_dir.exists())
print("Test 폴더 존재 여부:", test_dir.exists())
...
print(f"총 {n_folds}개 fold 중 1개만 학습 예정.")
...
class DriverDataset(Dataset):
    def __init__(self, data_dir, driver_df, driver_list, transform=None, is_test=False):
        ...
        print(f"{'테스트셋' if is_test else f'운전자 {len(driver_list)}명'}, 이미지 {len(self.images)}개")
...
print(f"\nFold {fold_idx} 완료! Best Val Loss: {best_val_loss:.4f}")


# ======================
# 9. 테스트셋 예측 (Kaggle 제출용)
# ======================
print("\n📦 테스트 데이터 예측 중...")
...
print(f"\n✅ Submission 파일 생성 완료: {submission_file}")
